    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('contact_number', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='datarepo.contacts')),
            ],
        ),
        migrations.CreateModel(
            name='groups',
            fields=[
                ...
                ('created', models.DateTimeField()),
                ('contact_number', models.ManyToManyField(to='datarepo.contacts')),
            ],
        ),
        migrations.CreateModel(
            name='chats',
